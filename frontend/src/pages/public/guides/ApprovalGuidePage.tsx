...
export default function ApprovalGuidePage() {
  ...
  const sections = [
    {
      h: "1. The Super Admin Role",
      p: "Super Admins act as the primary gatekeepers of the platform. Their responsibility is to maintain the security and legitimacy of the network by auditing every institution that requests to participate in the E-Clearance ecosystem."
    },
    {
      h: "2. Verification Standards",
      p: "The approval process involves a rigorous check of the institution's credentials. This includes validating official contact information, confirming the administrator's position, and most importantly, verifying the ownership of the provided academic email domain."
    },
    {
      h: "3. Domain Integrity",
      p: "By ensuring that only legitimate institutional domains are registered, the Super Admin system prevents unauthorized entities from accessing student data. This domain-based isolation is the foundation of our security architecture."
    },
    {
      h: "4. System-Wide Audits",
      p: "The Super Admin dashboard provides a bird's-eye view of all platform activities. This includes monitoring broadcast announcements, reviewing institution-specific analytics, and performing deep-dive audits of system logs to ensure total platform transparency."
    },
    {
      h: "5. Compliance & Ethics",
      p: "The approval process is governed by strict compliance standards. Super Admins ensure that every institution adheres to the platform's terms of service and data privacy policies, protecting the sensitive academic records of thousands of students."
    }
  ];
          ...
          <Box display="flex" alignItems="center" gap={5}>
            {navLinks.map((link) => (
              <Typography 
                ...
                sx={{ 
                  fontWeight: 600, fontSize: "14px", color: C.black, opacity: link.path === "/guides/approval" ? 1 : 0.6, cursor: "pointer",
                  "&:hover": { opacity: 1 }
                }}
              >
                {link.label}
