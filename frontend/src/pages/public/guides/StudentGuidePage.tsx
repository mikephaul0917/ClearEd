  ...
  const sections = [
    {
      ...
      p: "To begin your digital clearance journey, register with your official institutional email address. This step ensures that you are automatically linked to your school's unique workflow. Personal email domains are restricted to maintain institutional security."
    },
    {
      h: "2. Exploring Organizations",
      p: "Once logged in, you can browse through various campus organizations, departments, and offices. Each entry will show you the specific requirements needed for clearance within that particular entity."
    },
    {
      h: "3. Submitting Requirements",
      p: "Requirements vary by organization. You may be asked to upload digital documents, provide brief text statements, or simply attend a physical check-in. You can submit these directly through your student dashboard with a single click."
    },
    {
      h: "4. Real-Time Status Tracking",
      p: "No more wondering about your status. Your dashboard provides a live view of every organization's review process. You can see when an officer has viewed your submission and receive instant notifications upon approval or if remarks are provided."
    },
    {
      h: "5. Digital Clearance Slip",
      p: "When all required organizations have approved your clearance, the system automatically generates your official Digital Clearance Slip. This secure, verifiable document can be presented to the Registrar or other offices as proof of completion."
    }
  ];
          ...
          <Box display="flex" alignItems="center" gap={5}>
            {navLinks.map((link) => (
              <Typography 
                ...
                sx={{ 
                  fontWeight: 600, fontSize: "14px", color: C.black, opacity: link.path === "/guides/student" ? 1 : 0.6, cursor: "pointer",
                  "&:hover": { opacity: 1 }
                }}
              >
                {link.label}
