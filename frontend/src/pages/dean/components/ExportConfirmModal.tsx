        ...
        {open && (
          ...
          >
            <Box display="flex" flexDirection="column" alignItems="center" gap={2}>
              ...
              >
                Are You Sure <br /> Want To Export?
              </Typography>
              ...
              >
                You haven't selected any students. Do you want to export all <strong>{count}</strong> students in the current filtered view?
              </Typography>
              ...
              <Box sx={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 1.5 }}>
                ...
                >
                  {loading ? 'Processing...' : "Yes, Export All"}
                </Button>
